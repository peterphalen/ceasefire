...
We can also use this model to see the impact of the ceasefire at specific points in time. For example, here is the model-estimated impact of the next ceasefire, which will begin on Friday May 10th, 2019.
...
Without a ceasefire, we would expect about three people to get shot on the first day of the weekend, on average. But this will be a Ceasefire weekend, so the model expects about two fewer shootings per day.
