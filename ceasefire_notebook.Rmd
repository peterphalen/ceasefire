...
ceasefire.frame %>% 
  ...
  xlab("") + 
  ylab("Shootings") +
  ggtitle("Predicted shooting count",
          subtitle="with 95% credible intervals") +
  theme_bw()
```

On an average summer day in Baltimore in the year 2018, at least three people were shot. But Ceasefire weekends were different. Ceasefires appear to have prevented about two shootings per day.
